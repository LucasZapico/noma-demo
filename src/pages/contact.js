  ...
  return (
    <Layout>
      <div className="page w__100 w__80--lg center">
        <div className="flex justify__between--md justify__center flex__column flex__row--m margin__y--m">
          <div>
        ...
        <div className="flex card  justify__start flex__column flex__row--m  items__center padding__y--m">
